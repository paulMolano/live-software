...
Board setup, starter epics, starter sub-issues and recommended views live in
[`project-operating-model.md`](project-operating-model.md).

Issue refinement guidance lives in
[`../playbooks/refine-issue.md`](../playbooks/refine-issue.md).
...
| `Guide` | Living guide, journey, technology routes, decisions and learning documentation. |
